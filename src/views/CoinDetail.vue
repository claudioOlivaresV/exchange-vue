...
export default {
    ...
    created () {
        // cada vez que se crea el componente llama a get coin
        this.getCoin()

    },
    // agregamos este watcher para las url del header al cambiar, no actualizava y ahora si
    watch: {
        $route (){
            this.getCoin();
        ...
        getWebSite(exchange) {
         this.$set(exchange, 'isLoading', true )
            ...
            .then(res => {
                ...
                // problema de reactiviad al crear una nueva propiedad luego de la creacion
